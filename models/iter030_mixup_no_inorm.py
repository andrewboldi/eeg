"""Iteration 030: Mixup augmentation WITHOUT InstanceNorm.

Hypothesis: iter024 (mixup+InstanceNorm) got r=0.375, but InstanceNorm hurts
(iter020=0.375 vs iter017=0.378). Test mixup on top of the proven iter017
recipe (FIR + combined loss + corr validation + channel dropout) to isolate
whether mixup itself helps.

Expected: +0.001-0.005 from mixup alone, without InstanceNorm dragging it down.
"""
